#!/usr/bin/env python3
"""Isolated action: STRAFE LEFT (ramped) then pause holding depth.
...
def main():
    ...
    with session(confirm_msg='WILL STRAFE LEFT. Thrusters WILL spin.',
                 skip_confirm=args.yes) as (driver, _):
        driver.ramp_move('strafe_left', args.speed,
