...
#    ('2. forward 11 ft',     FWD1_THRUST,      0,                 125,       0,           FWD1_TIME,      False)
#    ('3. strafe right 4 ft', 0,                STRAFE_R_THRUST,   150,       0,           STRAFE_R_TIME,  False),
 #   ('4. forward 4 ft',      FWD2_THRUST,      0,                 170,       0,           FWD2_TIME,      False),
  #  ('5. strafe left 7 ft',  0,                -STRAFE_L1_THRUST, 170,       0,           STRAFE_L1_TIME, False),
   # ('6. turn 180°',         0,                0,                 170,       TURN_THRUST, TURN_TIME,      True),
