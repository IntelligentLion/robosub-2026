...
{
  new (message_memory) auv_msgs::msg::BehaviorStatus(_init);
}

void BehaviorStatus_fini_function(void * message_memory)
{
  auto typed_message = static_cast<auv_msgs::msg::BehaviorStatus *>(message_memory);
  typed_message->~BehaviorStatus();
}

static const ::rosidl_typesupport_introspection_cpp::MessageMember BehaviorStatus_message_member_array[4] = {
  {
    "stamp",  // name
    ...
    offsetof(auv_msgs::msg::BehaviorStatus, stamp),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(auv_msgs::msg::BehaviorStatus, action_name),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(auv_msgs::msg::BehaviorStatus, status),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(auv_msgs::msg::BehaviorStatus, reason),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers BehaviorStatus_message_members = {
  ...
  4,  // number of fields
  sizeof(auv_msgs::msg::BehaviorStatus),
...
get_message_type_support_handle<auv_msgs::msg::BehaviorStatus>()
{
  return &::auv_msgs::msg::rosidl_typesupport_introspection_cpp::BehaviorStatus_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, auv_msgs, msg, BehaviorStatus)() {
  return &::auv_msgs::msg::rosidl_typesupport_introspection_cpp::BehaviorStatus_message_type_support_handle;
}
