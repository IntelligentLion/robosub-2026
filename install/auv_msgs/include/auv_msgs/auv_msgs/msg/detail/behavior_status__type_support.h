...
#ifndef AUV_MSGS__MSG__DETAIL__BEHAVIOR_STATUS__TYPE_SUPPORT_H_
#define AUV_MSGS__MSG__DETAIL__BEHAVIOR_STATUS__TYPE_SUPPORT_H_
...
#endif  // AUV_MSGS__MSG__DETAIL__BEHAVIOR_STATUS__TYPE_SUPPORT_H_
